...
RUN apk --no-cache add --virtual .build-deps --update \
    ...
    mkdir -p /var/opt/OpenECOMP_ETE/robot/assets/demo/service_mapping && cp -Rf /src/demo/service_mapping /var/opt/OpenECOMP_ETE/robot/assets/demo/service_mapping/ && \
    mkdir -p /var/opt/ONAP/demo/preload_data && cp -Rf /src/demo/preload_data /var/opt/ONAP/demo/preload_data/ && \
